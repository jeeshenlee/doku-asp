<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="merchant-inline-example.aspx.cs" Inherits="doku_library.example.merchant_inline_example" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            data.req_custom_form = ['cc-field', 'cvv-field', 'name-field', 'exp-field']; //div for each input
...
<section class="default-width">
    ...
    <div class="content-payment-channel padd-default">
        <div id="creditcard" class="channel">
            ...
            <form autocomplete="on" method="post" id="cc-valideform" action="../example-payment/merchant-inline-example.aspx">
                <ul>
